...
echo 'Line:57 ';print_r($_ql_header2);
//try{
    $data_list = $_ql->get("https://{$cfg_target_domain2}/{$phone}", [], $_ql_header2);
    echo 'Line:60 ';print_r($_ql->disguise_headers);echo '<br>';
    $dataResult = $data_list->find('#mw-content-text>.right:eq(0)>ul:eq(0)>li:eq(1)>a')->text();
    echo 'Line:62 ';var_dump($dataResult);echo '<br>';
//} catch(Exception $e){
    //echo 'Line:64 ';print_r($e);
//}
